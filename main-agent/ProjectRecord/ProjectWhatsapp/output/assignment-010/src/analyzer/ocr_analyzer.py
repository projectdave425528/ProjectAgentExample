...
from src.analyzer.amount_extractor import AmountExtractor, extract_amounts
from src.analyzer.payment_detector import PaymentDetector, detect_payment_method
from src.models.config import AppConfig
from src.models.image_result import ImageAnalysisResult

_SUPPORTED_EXTENSIONS = {".jpg", ".jpeg", ".png", ".webp"}

# Module-level instances for internal use
