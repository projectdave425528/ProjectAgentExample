...
- **路徑**：`./ProjectRecord/{active-project}/decision-logs/evaluator/`
- **命名格式**：`decision-log-{assignment-id}-step{N}-{step-name}.md`
- **例如**：`decision-log-A003-step4-verdict-reason.md`
...
3. 填寫所有欄位
4. 寫入 `./ProjectRecord/{active-project}/decision-logs/evaluator/`
