...
- **路徑**：`./ProjectRecord/{active-project}/decision-logs/generator/`
- **命名格式**：`decision-log-{assignment-id}-step{N}-{step-name}.md`
- **例如**：`decision-log-A002-step3-choose-pattern.md`
...
3. 填寫所有欄位
4. 寫入 `./ProjectRecord/{active-project}/decision-logs/generator/`
